"""
MAATS Multi-Agent workflow WITH TERMINOLOGY: Zero-shot (with terminology) -> 7 specialized MQM evaluators -> Refinement.
Based on "MAATS: A Multi-Agent Automated Translation System Based on MQM Evaluation"

Workflow:
1. Zero-shot translation (with terminology dictionary if available)
...
def run_workflow(
    ...
    """
    Run MAATS multi-agent translation workflow with terminology support.
    
    Terminology is included in the zero-shot translation step (first step).
    The terminology agent will then evaluate the use of terminology in the translation.
    ...
    Args:
        ...
        terminology: Optional terminology dictionary (used in zero-shot translation)
        region: AWS region
    ...
    # Step 1: Zero-shot translation (with terminology if available)
