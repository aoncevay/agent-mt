...
Lựa chọn của bạn để chuẩn bị và nộp tờ khai thuế trực tuyến hoặc nộp tại cộng đồng địa phương, nếu bạn đủ điều kiện, bao gồm những điều sau đây.
  ...
  * **MilTax.** Các thành viên của Quân Đội Hoa Kỳ và các cựu chiến binh đủ điều kiện có thể sử dụng MilTax, một dịch vụ thuế miễn phí do Bộ Quốc Phòng cung cấp thông qua Military OneSource. Để biết thêm thông tin, truy cập MilitaryOneSource (tiếng Anh) (MilitaryOneSource.mil/MilTax).
...
Truy cập IRS.gov/Tools để tiếp cận những công cụ sau.
  ...
  * Trợ lý Tín thuế Thu nhập kiếm được (IRS.gov/EITCAssistant) xác định xem liệu bạn có đủ điều kiện nhận khoản tín thuế thu nhập kiếm được (EIC) hay không.
  * Đơn xin EIN trực tuyến (IRS.gov/EIN) giúp bạn có được mã số thuế của chủ lao động (EIN) miễn phí.
...
**Lấy ấn phẩm và hướng dẫn về thuế ở định dạng eBook.**
